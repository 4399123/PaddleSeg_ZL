...
def parse_args():
    ...
    parser.add_argument("--config", default='../configs/pp_mobileseg/pp_mobileseg_base_blueface.yml')
    parser.add_argument('--model_path', default=r'../deepmodel/pp_mobileseg_base/model.pdparams')
