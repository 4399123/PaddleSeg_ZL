...
def parse_args():
    ...
    parser.add_argument("--config", default='../configs/topformer/topformer_tiny_blueface.yml')
    parser.add_argument('--model_path', default=r'../deepmodel/topformer_tiny/model.pdparams')
