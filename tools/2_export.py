...
def parse_args():
    ...
    parser.add_argument("--config", default='../configs/mobileseg/mobileseg_mobilenetv2_blueface.yml')
    parser.add_argument('--model_path', default=r'../deepmodel/mobileseg_mv2/model.pdparams')
