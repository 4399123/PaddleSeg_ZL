...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, default='./onnx/',help="inference model filepath")
    parser.add_argument(
        "--model_filename",
        type=str,
    ...
    parser.add_argument(
        "--image_file",
        type=str,
        default='./imgs/0022-1_10_6_512xx512.jpg',
        help="Image path to be processed.")
    parser.add_argument(
        "--save_file",
        type=str,
        default='res_qat_fp32.png',
    ...
    parser.add_argument(
        "--config", type=str, default='./act_configs/datasets/seaformer_base_1.0_data.yml', help="path to config.")
    parser.add_argument(
        "--benchmark",
        type=bool,
        default=False,
